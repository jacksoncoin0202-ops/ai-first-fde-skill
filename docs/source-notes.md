...
This public repository uses only public-safe research notes.
...
- Microsoft WorkLab — 2024 Work Trend Index, AI at Work Is Here. Now Comes the Hard Part: https://www.microsoft.com/en-us/worklab/work-trend-index/ai-at-work-is-here-now-comes-the-hard-part

### Governance, risk, and responsible AI sources
...
Private local notes, client materials, decks, and internal research files may inform the maintainer's thinking, but they must not be cited as public sources unless they are explicitly public and approved for release.

This repository does not claim endorsement by Stanford, NIST, OECD, Microsoft, McKinsey, METI, MIC, or any referenced organization.
